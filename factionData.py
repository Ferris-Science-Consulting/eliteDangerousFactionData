...
def createTimeSeries(baseLineSystems,startDate,endDate,maxRadius,folder):
        ...
        while currentDate < endDate:
                ...
                if os.path.isfile(systemsfile):
                        ...
                        currentSystems = reduceSystemsCube(currentSystems,'Meliae',maxRadius)
...
def createNumericalModel (startDate,systemsURL,maxRadius,endDate,NewPkey,folder):
        ...
        baseLineSystems = reduceSystemsCube(baseLineSystems,'Meliae',maxRadius)
...
def createSeries(systems):
        ...
        for sysId,sys in systems.items():
                distance = distanceFromTarget(sys,findObject(systems,'Meliae'))
...
def test_findObject(systems):
        assert findObject(systems,'Meliae')['id'] == 13569, "Should be 13569"
